...
describe('Product e2e test', () => {
  ...
  const productSample = { name: 'jabber upside-down spike', price: 22386.38, productSize: 'S' };
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: { name: 'yuck aw predetermine', description: 'for' },
    }).then(({ body }) => {
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="name"]`).type('poorly hmph officially');
      cy.get(`[data-cy="name"]`).should('have.value', 'poorly hmph officially');

      cy.get(`[data-cy="description"]`).type('juicy');
      cy.get(`[data-cy="description"]`).should('have.value', 'juicy');

      cy.get(`[data-cy="price"]`).type('4769.93');
      cy.get(`[data-cy="price"]`).should('have.value', '4769.93');
