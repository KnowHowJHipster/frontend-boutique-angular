...
describe('ProductCategory e2e test', () => {
  ...
  const productCategorySample = { name: 'tedious darling' };
  ...
  describe('new ProductCategory page', () => {
    ...
    it('should create an instance of ProductCategory', () => {
      cy.get(`[data-cy="name"]`).type('marinate duh');
      cy.get(`[data-cy="name"]`).should('have.value', 'marinate duh');

      cy.get(`[data-cy="description"]`).type('plasticise psst jumbo');
      cy.get(`[data-cy="description"]`).should('have.value', 'plasticise psst jumbo');
