...
describe('ProductOrder Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Product query and add missing value', () => {
      ...
      const product: IProduct = { id: 12333 };
      productOrder.product = product;

      const productCollection: IProduct[] = [{ id: 6723 }];
    ...
    it('Should call ShoppingCart query and add missing value', () => {
      const productOrder: IProductOrder = { id: 456 };
      const cart: IShoppingCart = { id: 8605 };
      productOrder.cart = cart;

      const shoppingCartCollection: IShoppingCart[] = [{ id: 32237 }];
    ...
    it('Should update editForm', () => {
      const productOrder: IProductOrder = { id: 456 };
      const product: IProduct = { id: 9865 };
      productOrder.product = product;
      const cart: IShoppingCart = { id: 23058 };
      productOrder.cart = cart;
